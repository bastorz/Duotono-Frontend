  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 space-y-20">
      ...
      <div className="flex flex-col space-y-4 items-center">
        <p className="font-semibold text-xl">¡Muchas gracias por su compra!</p>
        <p className="font-semibold text-xl">
          Nos pondremos en contacto con usted próximamente para aclarar los
          detalles sobre el diseño que desea contratar.
        </p>
