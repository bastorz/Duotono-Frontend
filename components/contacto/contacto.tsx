  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-2 px-6 xl:px-36 pt-20 pb-4">
      <div className="flex flex-col space-y-2 items-center justify-center xl:items-start xl:justify-start">
        <h4 className="font-semibold uppercase tracking-widest text-center xl:text-start">
          Contáctanos
        </h4>
        <h5 className="font-bold text-3xl text-center xl:text-start">
          Ponte en contacto hoy
        </h5>
        <p className="max-w-[24rem] text-center xl:text-start">
          Descubre más sobre nuestros servicios y cómo podemos impulsar tu
      ...
      <form
        className="bg-first w-full xl:max-w-[38rem] p-10 rounded-xl"
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex flex-col space-y-4 xl:space-y-0">
            <label className="font-bold">
              ¿Has comprado ya el producto en nuestro sitio web?
            </label>
          ...
          <Button
            ...
            className={classNames({
              'text-white bg-black duration-200 transition': true,
