...
const PorqueNosotros = () => {
    ...
    <div className="grid grid-cols-1 xl:grid-cols-2 w-full place-items-center bg-black px-0 xl:px-10 2xl:px-40">
        <div className="my-0 xl:my-20">
            <Image src="/3.png" alt="1" width={700} height={700} className="bg-white xl:bg-black w-[1100px] xl:w-[700px]"/>
        </div>
        <div className="flex flex-col space-y-10 items-center xl:items-start h-full py-20">
            <h2 className="font-bold text-5xl xl:text-5xl text-center text-white">¿Por qué nosotros?</h2>
            <p className="text-black/80 max-w-[600px] text-center xl:text-left text-white px-4 xl:px-0">Imprenta digital de vanguardia. Calidad, rapidez y atención personalizada que marcan la diferencia.</p>
